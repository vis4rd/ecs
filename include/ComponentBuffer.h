...
public:
	...
	const std::any &getComponentByIndex(const uint16 type_index, const uint64 entity_id) const
	{
		switch(type_index)
		{
			case uint16{0}: { if constexpr(0 < sizeof...(Typepack)){ return m_cBuffer[type_index][0]; } else{ return std::any{}; } break; }
			case uint16{1}: { if constexpr(1 < sizeof...(Typepack)){ return m_cBuffer[type_index][1]; } else{ return std::any{}; } break; }
			case uint16{2}: { if constexpr(2 < sizeof...(Typepack)){ return m_cBuffer[type_index][2]; } else{ return std::any{}; } break; }
			case uint16{3}: { if constexpr(3 < sizeof...(Typepack)){ return m_cBuffer[type_index][3]; } else{ return std::any{}; } break; }
			case uint16{4}: { if constexpr(4 < sizeof...(Typepack)){ return m_cBuffer[type_index][4]; } else{ return std::any{}; } break; }
			case uint16{5}: { if constexpr(5 < sizeof...(Typepack)){ return m_cBuffer[type_index][5]; } else{ return std::any{}; } break; }
			case uint16{6}: { if constexpr(6 < sizeof...(Typepack)){ return m_cBuffer[type_index][6]; } else{ return std::any{}; } break; }
			case uint16{7}: { if constexpr(7 < sizeof...(Typepack)){ return m_cBuffer[type_index][7]; } else{ return std::any{}; } break; }
			case uint16{8}: { if constexpr(8 < sizeof...(Typepack)){ return m_cBuffer[type_index][8]; } else{ return std::any{}; } break; }
			case uint16{9}: { if constexpr(9 < sizeof...(Typepack)){ return m_cBuffer[type_index][9]; } else{ return std::any{}; } break; }
			case uint16{10}: { if constexpr(10 < sizeof...(Typepack)){ return m_cBuffer[type_index][10]; } else{ return std::any{}; } break; }
			case uint16{11}: { if constexpr(11 < sizeof...(Typepack)){ return m_cBuffer[type_index][11]; } else{ return std::any{}; } break; }
			case uint16{12}: { if constexpr(12 < sizeof...(Typepack)){ return m_cBuffer[type_index][12]; } else{ return std::any{}; } break; }
			case uint16{13}: { if constexpr(13 < sizeof...(Typepack)){ return m_cBuffer[type_index][13]; } else{ return std::any{}; } break; }
			case uint16{14}: { if constexpr(14 < sizeof...(Typepack)){ return m_cBuffer[type_index][14]; } else{ return std::any{}; } break; }
			case uint16{15}: { if constexpr(15 < sizeof...(Typepack)){ return m_cBuffer[type_index][15]; } else{ return std::any{}; } break; }
			case uint16{16}: { if constexpr(16 < sizeof...(Typepack)){ return m_cBuffer[type_index][16]; } else{ return std::any{}; } break; }
			case uint16{17}: { if constexpr(17 < sizeof...(Typepack)){ return m_cBuffer[type_index][17]; } else{ return std::any{}; } break; }
			case uint16{18}: { if constexpr(18 < sizeof...(Typepack)){ return m_cBuffer[type_index][18]; } else{ return std::any{}; } break; }
			case uint16{19}: { if constexpr(19 < sizeof...(Typepack)){ return m_cBuffer[type_index][19]; } else{ return std::any{}; } break; }
			case uint16{20}: { if constexpr(20 < sizeof...(Typepack)){ return m_cBuffer[type_index][20]; } else{ return std::any{}; } break; }
			case uint16{21}: { if constexpr(21 < sizeof...(Typepack)){ return m_cBuffer[type_index][21]; } else{ return std::any{}; } break; }
			case uint16{22}: { if constexpr(22 < sizeof...(Typepack)){ return m_cBuffer[type_index][22]; } else{ return std::any{}; } break; }
			case uint16{23}: { if constexpr(23 < sizeof...(Typepack)){ return m_cBuffer[type_index][23]; } else{ return std::any{}; } break; }
			case uint16{24}: { if constexpr(24 < sizeof...(Typepack)){ return m_cBuffer[type_index][24]; } else{ return std::any{}; } break; }
			case uint16{25}: { if constexpr(25 < sizeof...(Typepack)){ return m_cBuffer[type_index][25]; } else{ return std::any{}; } break; }
			case uint16{26}: { if constexpr(26 < sizeof...(Typepack)){ return m_cBuffer[type_index][26]; } else{ return std::any{}; } break; }
			case uint16{27}: { if constexpr(27 < sizeof...(Typepack)){ return m_cBuffer[type_index][27]; } else{ return std::any{}; } break; }
			case uint16{28}: { if constexpr(28 < sizeof...(Typepack)){ return m_cBuffer[type_index][28]; } else{ return std::any{}; } break; }
			case uint16{29}: { if constexpr(29 < sizeof...(Typepack)){ return m_cBuffer[type_index][29]; } else{ return std::any{}; } break; }
			case uint16{30}: { if constexpr(30 < sizeof...(Typepack)){ return m_cBuffer[type_index][30]; } else{ return std::any{}; } break; }
			case uint16{31}: { if constexpr(31 < sizeof...(Typepack)){ return m_cBuffer[type_index][31]; } else{ return std::any{}; } break; }
			case uint16{32}: { if constexpr(32 < sizeof...(Typepack)){ return m_cBuffer[type_index][32]; } else{ return std::any{}; } break; }
			case uint16{33}: { if constexpr(33 < sizeof...(Typepack)){ return m_cBuffer[type_index][33]; } else{ return std::any{}; } break; }
			case uint16{34}: { if constexpr(34 < sizeof...(Typepack)){ return m_cBuffer[type_index][34]; } else{ return std::any{}; } break; }
			case uint16{35}: { if constexpr(35 < sizeof...(Typepack)){ return m_cBuffer[type_index][35]; } else{ return std::any{}; } break; }
			case uint16{36}: { if constexpr(36 < sizeof...(Typepack)){ return m_cBuffer[type_index][36]; } else{ return std::any{}; } break; }
			case uint16{37}: { if constexpr(37 < sizeof...(Typepack)){ return m_cBuffer[type_index][37]; } else{ return std::any{}; } break; }
			case uint16{38}: { if constexpr(38 < sizeof...(Typepack)){ return m_cBuffer[type_index][38]; } else{ return std::any{}; } break; }
			case uint16{39}: { if constexpr(39 < sizeof...(Typepack)){ return m_cBuffer[type_index][39]; } else{ return std::any{}; } break; }
			case uint16{40}: { if constexpr(40 < sizeof...(Typepack)){ return m_cBuffer[type_index][40]; } else{ return std::any{}; } break; }
			case uint16{41}: { if constexpr(41 < sizeof...(Typepack)){ return m_cBuffer[type_index][41]; } else{ return std::any{}; } break; }
			case uint16{42}: { if constexpr(42 < sizeof...(Typepack)){ return m_cBuffer[type_index][42]; } else{ return std::any{}; } break; }
			case uint16{43}: { if constexpr(43 < sizeof...(Typepack)){ return m_cBuffer[type_index][43]; } else{ return std::any{}; } break; }
			case uint16{44}: { if constexpr(44 < sizeof...(Typepack)){ return m_cBuffer[type_index][44]; } else{ return std::any{}; } break; }
			case uint16{45}: { if constexpr(45 < sizeof...(Typepack)){ return m_cBuffer[type_index][45]; } else{ return std::any{}; } break; }
			case uint16{46}: { if constexpr(46 < sizeof...(Typepack)){ return m_cBuffer[type_index][46]; } else{ return std::any{}; } break; }
			case uint16{47}: { if constexpr(47 < sizeof...(Typepack)){ return m_cBuffer[type_index][47]; } else{ return std::any{}; } break; }
			case uint16{48}: { if constexpr(48 < sizeof...(Typepack)){ return m_cBuffer[type_index][48]; } else{ return std::any{}; } break; }
			case uint16{49}: { if constexpr(49 < sizeof...(Typepack)){ return m_cBuffer[type_index][49]; } else{ return std::any{}; } break; }
			case uint16{50}: { if constexpr(50 < sizeof...(Typepack)){ return m_cBuffer[type_index][50]; } else{ return std::any{}; } break; }
			case uint16{51}: { if constexpr(51 < sizeof...(Typepack)){ return m_cBuffer[type_index][51]; } else{ return std::any{}; } break; }
			case uint16{52}: { if constexpr(52 < sizeof...(Typepack)){ return m_cBuffer[type_index][52]; } else{ return std::any{}; } break; }
			case uint16{53}: { if constexpr(53 < sizeof...(Typepack)){ return m_cBuffer[type_index][53]; } else{ return std::any{}; } break; }
			case uint16{54}: { if constexpr(54 < sizeof...(Typepack)){ return m_cBuffer[type_index][54]; } else{ return std::any{}; } break; }
			case uint16{55}: { if constexpr(55 < sizeof...(Typepack)){ return m_cBuffer[type_index][55]; } else{ return std::any{}; } break; }
			case uint16{56}: { if constexpr(56 < sizeof...(Typepack)){ return m_cBuffer[type_index][56]; } else{ return std::any{}; } break; }
			case uint16{57}: { if constexpr(57 < sizeof...(Typepack)){ return m_cBuffer[type_index][57]; } else{ return std::any{}; } break; }
			case uint16{58}: { if constexpr(58 < sizeof...(Typepack)){ return m_cBuffer[type_index][58]; } else{ return std::any{}; } break; }
			case uint16{59}: { if constexpr(59 < sizeof...(Typepack)){ return m_cBuffer[type_index][59]; } else{ return std::any{}; } break; }
			case uint16{60}: { if constexpr(60 < sizeof...(Typepack)){ return m_cBuffer[type_index][60]; } else{ return std::any{}; } break; }
			case uint16{61}: { if constexpr(61 < sizeof...(Typepack)){ return m_cBuffer[type_index][61]; } else{ return std::any{}; } break; }
			case uint16{62}: { if constexpr(62 < sizeof...(Typepack)){ return m_cBuffer[type_index][62]; } else{ return std::any{}; } break; }
			case uint16{63}: { if constexpr(63 < sizeof...(Typepack)){ return m_cBuffer[type_index][63]; } else{ return std::any{}; } break; }
			default:
			{
				throw std::out_of_range(
				"const std::any &getComponentByIndex(const uint16 type_index, const uint64 entity_id) const: Given index is out of range (0-63).");
				break;
			}
		}
		int test1 = 8;
	...
	std::any &getComponentByIndex(const uint16 type_index, const uint64 entity_id)
	{
		switch(type_index)
		{
			case uint16{0}: { if constexpr(0 < sizeof...(Typepack)){ return m_cBuffer[type_index][0]; } else{break;} break; }
			case uint16{1}: { if constexpr(1 < sizeof...(Typepack)){ return m_cBuffer[type_index][1]; } else{break;} break; }
			case uint16{2}: { if constexpr(2 < sizeof...(Typepack)){ return m_cBuffer[type_index][2]; } else{break;} break; }
			case uint16{3}: { if constexpr(3 < sizeof...(Typepack)){ return m_cBuffer[type_index][3]; } else{break;} break; }
			case uint16{4}: { if constexpr(4 < sizeof...(Typepack)){ return m_cBuffer[type_index][4]; } else{break;} break; }
			case uint16{5}: { if constexpr(5 < sizeof...(Typepack)){ return m_cBuffer[type_index][5]; } else{break;} break; }
			case uint16{6}: { if constexpr(6 < sizeof...(Typepack)){ return m_cBuffer[type_index][6]; } else{break;} break; }
			case uint16{7}: { if constexpr(7 < sizeof...(Typepack)){ return m_cBuffer[type_index][7]; } else{break;} break; }
			case uint16{8}: { if constexpr(8 < sizeof...(Typepack)){ return m_cBuffer[type_index][8]; } else{break;} break; }
			case uint16{9}: { if constexpr(9 < sizeof...(Typepack)){ return m_cBuffer[type_index][9]; } else{break;} break; }
			case uint16{10}: { if constexpr(10 < sizeof...(Typepack)){ return m_cBuffer[type_index][10]; } else{break;} break; }
			case uint16{11}: { if constexpr(11 < sizeof...(Typepack)){ return m_cBuffer[type_index][11]; } else{break;} break; }
			case uint16{12}: { if constexpr(12 < sizeof...(Typepack)){ return m_cBuffer[type_index][12]; } else{break;} break; }
			case uint16{13}: { if constexpr(13 < sizeof...(Typepack)){ return m_cBuffer[type_index][13]; } else{break;} break; }
			case uint16{14}: { if constexpr(14 < sizeof...(Typepack)){ return m_cBuffer[type_index][14]; } else{break;} break; }
			case uint16{15}: { if constexpr(15 < sizeof...(Typepack)){ return m_cBuffer[type_index][15]; } else{break;} break; }
			case uint16{16}: { if constexpr(16 < sizeof...(Typepack)){ return m_cBuffer[type_index][16]; } else{break;} break; }
			case uint16{17}: { if constexpr(17 < sizeof...(Typepack)){ return m_cBuffer[type_index][17]; } else{break;} break; }
			case uint16{18}: { if constexpr(18 < sizeof...(Typepack)){ return m_cBuffer[type_index][18]; } else{break;} break; }
			case uint16{19}: { if constexpr(19 < sizeof...(Typepack)){ return m_cBuffer[type_index][19]; } else{break;} break; }
			case uint16{20}: { if constexpr(20 < sizeof...(Typepack)){ return m_cBuffer[type_index][20]; } else{break;} break; }
			case uint16{21}: { if constexpr(21 < sizeof...(Typepack)){ return m_cBuffer[type_index][21]; } else{break;} break; }
			case uint16{22}: { if constexpr(22 < sizeof...(Typepack)){ return m_cBuffer[type_index][22]; } else{break;} break; }
			case uint16{23}: { if constexpr(23 < sizeof...(Typepack)){ return m_cBuffer[type_index][23]; } else{break;} break; }
			case uint16{24}: { if constexpr(24 < sizeof...(Typepack)){ return m_cBuffer[type_index][24]; } else{break;} break; }
			case uint16{25}: { if constexpr(25 < sizeof...(Typepack)){ return m_cBuffer[type_index][25]; } else{break;} break; }
			case uint16{26}: { if constexpr(26 < sizeof...(Typepack)){ return m_cBuffer[type_index][26]; } else{break;} break; }
			case uint16{27}: { if constexpr(27 < sizeof...(Typepack)){ return m_cBuffer[type_index][27]; } else{break;} break; }
			case uint16{28}: { if constexpr(28 < sizeof...(Typepack)){ return m_cBuffer[type_index][28]; } else{break;} break; }
			case uint16{29}: { if constexpr(29 < sizeof...(Typepack)){ return m_cBuffer[type_index][29]; } else{break;} break; }
			case uint16{30}: { if constexpr(30 < sizeof...(Typepack)){ return m_cBuffer[type_index][30]; } else{break;} break; }
			case uint16{31}: { if constexpr(31 < sizeof...(Typepack)){ return m_cBuffer[type_index][31]; } else{break;} break; }
			case uint16{32}: { if constexpr(32 < sizeof...(Typepack)){ return m_cBuffer[type_index][32]; } else{break;} break; }
			case uint16{33}: { if constexpr(33 < sizeof...(Typepack)){ return m_cBuffer[type_index][33]; } else{break;} break; }
			case uint16{34}: { if constexpr(34 < sizeof...(Typepack)){ return m_cBuffer[type_index][34]; } else{break;} break; }
			case uint16{35}: { if constexpr(35 < sizeof...(Typepack)){ return m_cBuffer[type_index][35]; } else{break;} break; }
			case uint16{36}: { if constexpr(36 < sizeof...(Typepack)){ return m_cBuffer[type_index][36]; } else{break;} break; }
			case uint16{37}: { if constexpr(37 < sizeof...(Typepack)){ return m_cBuffer[type_index][37]; } else{break;} break; }
			case uint16{38}: { if constexpr(38 < sizeof...(Typepack)){ return m_cBuffer[type_index][38]; } else{break;} break; }
			case uint16{39}: { if constexpr(39 < sizeof...(Typepack)){ return m_cBuffer[type_index][39]; } else{break;} break; }
			case uint16{40}: { if constexpr(40 < sizeof...(Typepack)){ return m_cBuffer[type_index][40]; } else{break;} break; }
			case uint16{41}: { if constexpr(41 < sizeof...(Typepack)){ return m_cBuffer[type_index][41]; } else{break;} break; }
			case uint16{42}: { if constexpr(42 < sizeof...(Typepack)){ return m_cBuffer[type_index][42]; } else{break;} break; }
			case uint16{43}: { if constexpr(43 < sizeof...(Typepack)){ return m_cBuffer[type_index][43]; } else{break;} break; }
			case uint16{44}: { if constexpr(44 < sizeof...(Typepack)){ return m_cBuffer[type_index][44]; } else{break;} break; }
			case uint16{45}: { if constexpr(45 < sizeof...(Typepack)){ return m_cBuffer[type_index][45]; } else{break;} break; }
			case uint16{46}: { if constexpr(46 < sizeof...(Typepack)){ return m_cBuffer[type_index][46]; } else{break;} break; }
			case uint16{47}: { if constexpr(47 < sizeof...(Typepack)){ return m_cBuffer[type_index][47]; } else{break;} break; }
			case uint16{48}: { if constexpr(48 < sizeof...(Typepack)){ return m_cBuffer[type_index][48]; } else{break;} break; }
			case uint16{49}: { if constexpr(49 < sizeof...(Typepack)){ return m_cBuffer[type_index][49]; } else{break;} break; }
			case uint16{50}: { if constexpr(50 < sizeof...(Typepack)){ return m_cBuffer[type_index][50]; } else{break;} break; }
			case uint16{51}: { if constexpr(51 < sizeof...(Typepack)){ return m_cBuffer[type_index][51]; } else{break;} break; }
			case uint16{52}: { if constexpr(52 < sizeof...(Typepack)){ return m_cBuffer[type_index][52]; } else{break;} break; }
			case uint16{53}: { if constexpr(53 < sizeof...(Typepack)){ return m_cBuffer[type_index][53]; } else{break;} break; }
			case uint16{54}: { if constexpr(54 < sizeof...(Typepack)){ return m_cBuffer[type_index][54]; } else{break;} break; }
			case uint16{55}: { if constexpr(55 < sizeof...(Typepack)){ return m_cBuffer[type_index][55]; } else{break;} break; }
			case uint16{56}: { if constexpr(56 < sizeof...(Typepack)){ return m_cBuffer[type_index][56]; } else{break;} break; }
			case uint16{57}: { if constexpr(57 < sizeof...(Typepack)){ return m_cBuffer[type_index][57]; } else{break;} break; }
			case uint16{58}: { if constexpr(58 < sizeof...(Typepack)){ return m_cBuffer[type_index][58]; } else{break;} break; }
			case uint16{59}: { if constexpr(59 < sizeof...(Typepack)){ return m_cBuffer[type_index][59]; } else{break;} break; }
			case uint16{60}: { if constexpr(60 < sizeof...(Typepack)){ return m_cBuffer[type_index][60]; } else{break;} break; }
			case uint16{61}: { if constexpr(61 < sizeof...(Typepack)){ return m_cBuffer[type_index][61]; } else{break;} break; }
			case uint16{62}: { if constexpr(62 < sizeof...(Typepack)){ return m_cBuffer[type_index][62]; } else{break;} break; }
			case uint16{63}: { if constexpr(63 < sizeof...(Typepack)){ return m_cBuffer[type_index][63]; } else{break;} break; }
			default:
			{
				throw std::out_of_range(
				"std::any &getComponentByIndex(const uint16 type_index, const uint64 entity_id): Given index is out of range (0-63).");
				break;
			}
		}
		return m_cBuffer[type_index][63];
	}
	...
	{
		auto &ret = this->getComponentBucket<ComponentT>().emplace_back(
				ComponentWrapper<ComponentT>(entity_id));
		return std::any_cast<ComponentWrapper<ComponentT>&>(ret)();
	...
	std::vector<std::any> &getComponentBucket(const uint16 comp_index)
	{
		return m_cBuffer[comp_index];
	}
